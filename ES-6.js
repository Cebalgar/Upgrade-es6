...
const filtarGenero = videogames.filter( games=>games.genders.includes("RPG"));

console.log(filtarGenero);

const sumaScore= filtarGenero.reduce((accumulator , nota)=>accumulator + nota.score,0);

var promedioNotas = sumaScore / filtarGenero.length;
console.log(promedioNotas);
